<template>
    ...
    <!-- 广告位 -->
    <view class="banner" @click="goPage('/pages/news/detail?id=16')">
      <u-alert-tips type="warning" title="藏品委托寄售流程" :showIcon="true" :closeAble="true" closeText="点击查看"></u-alert-tips>
    </view>
    
		<view class="u-demo-wrap">
      <u-section title="上传寄售藏品信息" font-size="28" :show-line="false" :right="false"></u-section>
        ...
        <u-form :model="form" ref="uForm">
          ...
          <u-form-item><u-input class="input" :border="true" placeholder="藏品尺寸" v-model="form.size" /></u-form-item>
          ...
          <u-form-item><u-input :border="true" placeholder="请输入您的姓名" v-model="form.contact" /></u-form-item>
          <u-form-item><u-input type="number" :border="true" placeholder="请输入您的手机号" v-model="form.contact_tel" maxlength="11" /></u-form-item>
          <u-form-item><u-input type="number" :border="true" placeholder="请输入您的微信号" v-model="form.wechat" maxlength="25" /></u-form-item>
        </u-form>
        ...
        <view class="agree flex align-center">
          ...
          <view @click="showPop=true"><text class="u-font-12 text-red">《藏品委托寄售规则》</text></view>
        </view>
...
<script>
  ...
  import { submitConsign, getCategory, getConsignRule } from '@/api/api.js';
      ...
      submit() {
        ...
        if(!this.agree){
          return this.$refs.uTips.show({
            title: '请同意《藏品委托寄售规则》后提交',
            type: 'error',
            duration: '2300'
          })
        }
        if(!this.form.title || !this.form.intro || !this.form.cate_id || !this.form.contact || !this.form.contact_tel || !this.form.size || !this.form.wechat){
          return this.$refs.uTips.show({
            title: '请完整填写信息',
            type: 'error',
            duration: '2300'
        ...
        this.form.attach_ids = this.fileList;
        
        submitConsign(this.form).then(res=>{
