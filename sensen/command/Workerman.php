...
namespace sensen\command;

use Channel\Server;
use sensen\services\workerman\chat\ChatService;
use sensen\services\workerman\WorkermanService;
...
class Workerman extends Command
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        $confing = ConfigService::more(['wss_open', 'wss_local_cert', 'wss_local_pk']);
        // 证书最好是申请的证书
        if ($confing['wss_open']) {
            $context = [
                'ssl' => [
